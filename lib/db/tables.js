...
module.exports = {
  ...
  PermissionTable: {
    ...
    , defaultData: [
      ...
      { PermissionId: "551281ad-d3ed-41d5-a2d7-9a18bb891c6f", desc: "user group management",name:"用户组管理" },
      { PermissionId: "8e1d13b6-48f2-413c-aae1-03c244b11210", desc: "equipment group management",name:"设备组管理" },
      { PermissionId: "88ca3d8d-d989-4a6e-be8d-dc8d358bfa99", desc: "manual addition of equipment",name:"手动添加/管理设备" }
    ]
  }
}

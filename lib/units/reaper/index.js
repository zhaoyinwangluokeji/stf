...
module.exports = function (options) {
  ...
  function SynUser() {
    ...
    console.log("SynUser Timer is coming")
      ...
      devicelist.forEach(device => {
        AllPromises.push(new Promise(function (resolve) {
          ...
          if (re > 0) {
            var subject
            if (re == 1) {
              subject = "Your rented phone:" + device.serial + "," + device.productNo + " is about to expire,about 30 minutes"
            } else if (re == 2) {
              subject = "Your rented phone:" + device.serial + "," + device.productNo + " has expired"
            }

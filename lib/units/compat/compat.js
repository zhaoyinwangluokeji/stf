...
module.exports = function(options) {
  ...
  log.info('host:' + options.adbHost + ', port: ' + options.adbPort)
  adb.listDevices().then(function(result){
    log.info('devices:' +  JSON.stringify(result))
  })
  executor.setADB(adb)
  ...
  function pushApp(serial, href) {
    ...
    return adb.push(serial, source, target)
      .timeout(10000)
              ...
              if (error !== null) {
                ...
                .then(function(){
                  serials.forEach(serial => {
                    ...
                    adb.listDevices().then(function(result){
                      log.info('devices222:' +  JSON.stringify(result))
                    })

...
module.exports = db.ensureConnectivity(function(options) {
  ...
  devDealer.on('message', wirerouter()
    ...
    .on(wire.LeaveGroupMessage, function(channel, message, data) {
      console.log("processor:wire.LeaveGroupMessage:channel ->"+JSON.stringify(channel))
      console.log("processor:wire.LeaveGroupMessage:message ->"+JSON.stringify(message))
      console.log("processor:wire.LeaveGroupMessage:data ->"+JSON.stringify(data))
    ...
    .on(wire.DeviceRentMessage, function(channel, message, data) {
      console.log("DeviceRentMessage1:"+channel)
      console.log("DeviceRentMessage1 data:"+JSON.stringify(data))
      appDealer.send([channel, data])
      console.log("DeviceRentMessage2:"+JSON.stringify(data))
    })
    .handler())

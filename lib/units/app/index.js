...
var mobileImagesIconMiddleware = require('./middleware/mobile-images')
...
module.exports = function (options) {
  ...
  app.use('/static/app/mobile-images', mobileImagesIconMiddleware())
    ...
    dbapi.loadAllUserGroups().then(function (cursor) {
      ...
      if (!is_adminstrator_group) {
        ...
        var state = {
          ...
          , password_modified: req.session.jwt && req.session.jwt.password_modified && req.session.jwt.password_modified == true ? true : false
        }

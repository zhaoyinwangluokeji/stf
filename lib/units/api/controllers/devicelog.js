...
function getLogs(req, res) {
    ...
    var enddate = req.query.enddate ? req.query.enddate : Date.now();
    var startrow = req.query.startrow ? req.query.startrow : 0;
    var rowcnt = req.query.rowcnt ? req.query.rowcnt : 30;
    var field = req.query.field ? req.query.field : "";
    var filter = req.query.filter ? req.query.filter : "";

    if (field == "" && filter == "") {
      return dbapi.getLogs(startdate)
...
function getStatisticsPerGroup(req, res) {
    var startdate = req.query.startdate ? req.query.startdate : "1970-01-01";
    var enddate = req.query.enddate ? req.query.enddate : new Date().format("yyyy-MM-dd");
